...
router.get("/vendor-profile",authMiddleware.auntenticate,authMiddleware.allowRoles(Role.Vendor),authMiddleware.checkBlocked,vendorProfileController.getVendorProfile)
