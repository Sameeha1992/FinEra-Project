export enum Errors {
  ...
  CORS_ORIGIN = "Cors origin should be assigned in the environment variables",
  ...
  ENV_STRIPE_WEBHOOK_SECRET_ERROR = "Stripe webhook secret is required",
 ENV_STRIPE_WEBHOOK_SECRET_INVALID = "Stripe webhook secret must start with whsec_",
}
